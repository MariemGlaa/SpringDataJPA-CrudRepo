...
public class FournisseurRestController {
	...
	public Fournisseur addFournisseur(FournisseurDTO fournisseurDTO) {
		Fournisseur fournisseur = Fournisseur.builder()
					...
					.categorieFournisseur(fournisseurDTO.getCategorieFournisseur()).build();
	...
	@ResponseBody
	public Fournisseur modifyFournisseur(FournisseurDTO fournisseurDTO) {
	...
	public void assignProduitToStock(@PathVariable("idSecteurActivite") Long idSecteurActivite, @PathVariable("idFournisseur") Long idFournisseur) throws NullPointerException, Exception {
